...
const SignUpForm = () => {
  ...
  return (
    <form onSubmit={handleSignUp} className="space-y-4 p-6 bg-white shadow-md rounded-lg">
      <h2 className="text-2xl font-bold text-center text-gray-800">Sign Up for Josh Gram</h2>
